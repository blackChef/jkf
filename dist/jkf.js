...
/***/ function(module, exports, __webpack_require__) {
	...
	var registerCombination = _require.registerCombination;
	var registeredCombinationProps = _require.registeredCombinationProps;

	var update = __webpack_require__(5);
	var animate = __webpack_require__(132);
	var parse = __webpack_require__(124);
	var prefix = __webpack_require__(134);
	var queuedAnimate = __webpack_require__(135);
	var registerTransform = __webpack_require__(136);
...
/***/ function(module, exports) {
	...
	function isCombination(subPropName) {
	  return registeredCombinationProps.find(function (item) {
	    return item.check(subPropName);
	  });
	}

	module.exports = { registerCombination: registerCombination, isCombination: isCombination, registeredCombinationProps: registeredCombinationProps };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isCombination = _require.isCombination;
	  ...
	  kf.forEach(function (kfItem) {
	    ...
	    if (!combination) {
	      ...
	      // 是 combination 的属性，先保存，最后再应用
	        ...
	        var name = combination.name;
	        var combine = combination.combine;

	        if (!combinations[name]) {
	          combinations[name] = { combine: combine, values: [{ propName: propName, value: value }] };
	        } else {
	          combinations[name].values.push({ propName: propName, value: value });
	        }
	      }
	  });
...
/***/ function(module, exports) {
	...
	function step1(original) {
	  ...
	  points.forEach(function (point, index, array) {
	    ...
	    Object.keys(rule).forEach(function (propName) {
	      var _match = (rule[propName] + '').match(/(-?[\d\.]+)(.*)/);

	      var _match2 = _slicedToArray(_match, 3);

	      var valueNum = _match2[1];
	      var valueUnit = _match2[2];
	...
	// 根据两点得到线性方程
	var setEquation = function setEquation(x1, y1, x2, y2) {
	  var k = (y1 - y2) / (x1 - x2);
	  var b = y1 - k * x1;
	...
	function compileRule(rule) {
	  ...
	  rule.forEach(function (curItem, index, array) {
	    ...
	    ret.push({ startPoint: startPoint, endPoint: endPoint, fn: fn });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var style = __webpack_require__(6);
	var BezierEasing = __webpack_require__(133);
	var parse = __webpack_require__(124);
	...
	function setAnimateOptions(options) {
	  ...
	  var from = _options$from === undefined ? 0 : _options$from;
	  var _options$to = options.to;
	  var to = _options$to === undefined ? 1 : _options$to;
	  var _options$onUpdate = options.onUpdate;
	  var onUpdate = _options$onUpdate === undefined ? function () {} : _options$onUpdate;
	  var _options$onEnd = options.onEnd;
	  var onEnd = _options$onEnd === undefined ? function () {} : _options$onEnd;
	  var _options$timingFunction = options.timingFunction;
	  var timingFunction = _options$timingFunction === undefined ? 'ease' : _options$timingFunction;
	  ...
	  var tf = Array.isArray(timingFunction) ? BezierEasing.call(null, timingFunction) : BezierEasing.css[timingFunction]; // keywords
